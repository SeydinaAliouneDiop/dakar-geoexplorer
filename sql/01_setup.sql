...
('Hôpital Le Dantec',             'hôpital',   'CHU spécialisé en cancérologie et neurologie','Avenue Pasteur, Dakar',               ST_SetSRID(ST_MakePoint(-17.4497, 14.6762), 4326)),
...
('École Polytechnique de Thiès',  'école',     'Grande école d ingénieurs',                   'Thiès, Sénégal',                      ST_SetSRID(ST_MakePoint(-16.9353, 14.8085), 4326)),
...
('Institut Supérieur de Gestion', 'école',     'École de commerce et gestion ISG',            'Mermoz, Dakar',                       ST_SetSRID(ST_MakePoint(-17.4820, 14.7050), 4326)),
...
('Marché Kermel',                 'marché',    'Marché colonial rénové, fruits et légumes',   'Plateau, Dakar',                      ST_SetSRID(ST_MakePoint(-17.4446, 14.6788), 4326)),
...
('Pharmacie Point E',             'pharmacie', 'Pharmacie quartier résidentiel Point E',      'Point E, Dakar',                      ST_SetSRID(ST_MakePoint(-17.4720, 14.6965), 4326)),
...
CREATE INDEX idx_lieux_geom_gist
    ON lieux
    USING GIST (geom);
